...
protoFile = "c:/python/Python37/site-packages/pose_deploy_linevec_faster_4_stages.prototxt"
weightsFile= "c:/python/Python37/site-packages/pose_iter_160000.caffemodel"
...
while cv2.waitKey(1) <0:  #아무 키나 누르면 끝난다.
    ...
    if (points[4] is not None) and (points[7] is not None):
      point_1 = points[4]
      point_2 = points[7]
      if (point_1[1] > point_2[1]) :
             cv2.putText(frame, "PYTHON",(0,10),cv2.FONT_HERSHEY_SIMPLEX,1,(0,255,0),2)
